<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
                <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Add Supplier</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">Create a new supplier record for your CLT project.</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" value="{{ old('name') }}" class="mt-2 block w-full" placeholder="e.g. Nordic Timber Co." />
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:justify-end">
                            ...
                            <x-primary-button class="rounded-full px-6 py-3">Save Supplier</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
